 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    elif (df['recency'][i] > 61) and (df['recency'][i] <= 120):\n",
    "        df['recency_score'][i] = 3\n",
    "    elif (df['recency'][i] > 121) and (df['recency'][i] <= 180):\n",
    ...
    "df['rfm_segment'] = df['rfm_segment'].astype(int)\n",
    ...
    "df['rfm score'] = df.iloc[:,31:34].sum(axis=1)\n",
    "\n",
    ...
    "plt.ylabel('Number of Customers');\n",
    "\n",
    "#which product customers order more\n",
    "\n",
    "best_seller_p = df['product_category_name'].value_counts().reset_index().nlargest(10,'product_category_name')\n",
    "worst_seller_p = df['product_category_name'].value_counts().reset_index().nsmallest(10,'product_category_name')\n",
    "\n",
    ...
    "\n",
    "plt.subplot(211)\n",
    "sns.barplot(data = best_seller_p, x = 'product_category_name', y = 'index', color = green_color)\n",
    "plt.title('Top 10 Products Ordered')\n",
    "plt.xlabel('Number of Orders')\n",
    "plt.ylabel('Product');\n",
    "\n",
    "plt.subplot(212)\n",
    "sns.barplot(data = worst_seller_p, x = 'product_category_name', y = 'index', color =red_color )\n",
